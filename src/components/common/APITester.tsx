  ...
  return (
    <div className="mx-auto mt-8 flex w-full max-w-2xl flex-col gap-4 text-left">
      ...
      >
        ...
        <button
          type="submit"
          className="cursor-pointer whitespace-nowrap rounded-lg border-0 bg-[#fbf0df] px-5 py-1.5 font-bold text-[#1a1a1a] transition-all duration-100 hover:-translate-y-px hover:bg-[#f3d5a3]"
        >
          Send
        </button>
      </form>
